...
class _AddPassState extends State<AddPass> {
  ...
  Future<bool> insertData(String key) async {
    ...
    final encryptedApplicationName = encrypter.encrypt(applicationName, iv: iv);
    ...
    try {
      await connection.query(
          "INSERT INTO USER_DATA(platform_name, password_digest) VALUES (@applicationName, @applicationPassword)",
          substitutionValues: {
